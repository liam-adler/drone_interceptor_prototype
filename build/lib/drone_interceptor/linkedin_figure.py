...
def build_figure(
    ...
    gs = fig.add_gridspec(2, 3, height_ratios=[2.3, 1.2], hspace=0.28, wspace=0.18)
    ...
    ax_top.set_title("Main result: baseline closes the gap faster and actually converts those close approaches into captures")
