...
edge through higher speed and stronger maneuvering limits. When threat response
is enabled, it can also switch into evasive behavior once the interceptor gets
close enough, which makes the interception problem meaningfully harder than a
passive target track.
